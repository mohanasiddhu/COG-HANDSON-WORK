    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/authenticate").permitAll() // Allow anonymous access to authentication endpoint
        ...
        // Register JwtRequestFilter before the standard UsernamePasswordAuthenticationFilter
